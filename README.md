...
Copy your assembly file in the 'src' folder (documentation for our assembly language an₫ processor architecture are available in the [functional](https://github.com/algosup/2023-2024-project-3-virtual-processor-team-4/tree/main/documents/functional) folder of the GitHub repository).
